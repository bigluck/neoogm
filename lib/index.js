/**
 * neoogm 0.0.1 <https://github.com/bigluck/neoogm>
    ...
    return models.node[node_label] = (function() {
      ...
      _Class.prototype.save = function(cb) {
        ...
        return neoogm.cypher({
          ...
          return typeof cb === "function" ? cb(null, self) : void 0;
        });
      };
      ...
      _Class.prototype.remove = function(cb) {
        var self;
        if (!this._id) {
          return cb(new NeoormError("Node could not be deleted without a valid id"));
        }
        self = this;
        return neoogm.cypher({
      ...
      _Class.update = function(options, cb) {
        var query_update, value, _ref1;
        if (typeof options === "function") {
          return typeof cb === "function" ? cb(new Error("No options found")) : void 0;
        }
        options = _.extend({
          query: null,
          params: {},
      ...
      _Class.findById = function(id, cb) {
        ...
        if (id == null) {
          return cb(new NeoormError("Node id not defined"));
        }
        return neoogm.cypher({
  ...
  neoogm.relationship = function(relationship_type, relationship_options) {
    ...
    return models.relationship[relationship_type] = (function() {
      ...
      _Class.prototype.save = function(cb) {
        ...
        if (this._start == null) {
          return typeof cb === "function" ? cb(new NeoormError("Start node not defined")) : void 0;
        }
        if (this._end == null) {
          return typeof cb === "function" ? cb(new NeoormError("End node not defined")) : void 0;
        }
        self = this;
        return async.waterfall([
          function(cb) {
      ...
      _Class.prototype.remove = function(cb) {
        var self;
        if (!this._id) {
          return cb(new NeoormError("Relationship could not be deleted without a valid id"));
        }
        self = this;
        return neoogm.cypher({
      ...
      _Class.prototype.getStart = function(cb) {
        ...
        return async.waterfall([
          ...
          self._start = item;
          return typeof cb === "function" ? cb(null, item) : void 0;
        });
      };
      ...
      _Class.findRelates = function(options, cb) {
        var model_label, value, _ref1, _ref2, _ref3, _ref4;
        if (typeof options === "function") {
          _ref1 = [{}, options], options = _ref1[0], cb = _ref1[1];
        }
        options = _.extend({
        ...
        if (!(model_label = (_ref2 = options.model) != null ? typeof _ref2.getLabel === "function" ? _ref2.getLabel() : void 0 : void 0)) {
          return typeof cb === "function" ? cb(new NeoormError("options.model have to be an Neoorm model")) : void 0;
        }
        if (((_ref3 = options.model) != null ? typeof _ref3.getId === "function" ? _ref3.getId() : void 0 : void 0) == null) {
          return typeof cb === "function" ? cb(new NeoormError("options.model is not an database reference")) : void 0;
        }
        if (options.query instanceof Array) {
          options.query = options.query.join(" ");
        } else if (typeof options.query === "object") {
        ...
        return neoogm.cypher({
          ...
          return cb(err, _.map(results, function(row, row_i) {
